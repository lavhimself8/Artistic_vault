    ...
    <div class="row mb-4">
        ...
        <div class="col-6 d-flex justify-content-end align-items-center">
            <form action="" class="tm-text-primary">
                Page <input type="text" value="<?= $data['page_current'] ?>" size="1"
    ...
    <div class="row tm-mb-90">
        <div class="col-12 d-flex justify-content-between align-items-center tm-paging-col">
            ...
            <div class="tm-paging d-flex">
                <a href="<?= $data['page_1'] ?>" class="active tm-paging-link">
                    <?= ($data['page_current']) ?>
                </a>
                <a href="<?= $data['page_2'] ?>" class="tm-paging-link">
                    <?= ($data['page_current'] + 1) ?>
                </a>
                <a href="<?= $data['page_3'] ?>" class="tm-paging-link">
                    <?= ($data['page_current'] + 2) ?>
                </a>
                <a href="<?= $data['page_4'] ?>" class="tm-paging-link">
                    <?= ($data['page_current'] + 3) ?>
                </a>
            </div>
